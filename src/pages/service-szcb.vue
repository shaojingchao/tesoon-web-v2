    ...
    <div class="service-detail content">
      ...
      <div class="detail-context">
        <div class="main-section">
          <img class="fr ml20" src="../assets/img/szcb_pro_01.png">
          <p>
    ...
    data () {
      return {
        routerNav: [
          {
            name: '天星教育网',
            to: {name: 'serviceshuzichuban_tianxingjiaoyu'}
          },
          {
            name: '微学习圈',
            to: {name: 'serviceshuzichuban_weixuexiquan'}
          },
          {
            name: '未来脑',
            to: {name: 'serviceshuzichuban_weilainao'}
          }
        ],
