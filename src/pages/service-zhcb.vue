      ...
      <div class="detail-context">
        ...
        <div class="pro-list-section" id="fkyd">
          ...
          <div class="pro-desc">
            ...
            <p>内容特色：时尚、地道、丰富、好用。<br>
              核心版块：环球、光影、风尚、美文、潮玩、酷学、乐读、英派。
              <br><a href="http://www.tesoon.com/read/" class="text-primary" target="_blank">了解更多&gt;</a></p>
          </div>
        </div>
        ...
        <div class="pro-list-section" id="fkzw">
          ...
          <div class="pro-desc">
            <h3>《疯狂作文》（初中版、高考版）</h3>
            <p>第1辑 （中）高考作文启示录<br>
              第2辑 初中作文优材大会-破解高考任务驱动型作文<br>
              第3辑  （中）高考作文速用模板<br>
              第4辑  年度热词时文盘点<br>
              第5辑  名校金题速递<br>
              第6辑  必考主题通关
              <br><a href="http://www.tesoon.com/read/" class="text-primary" target="_blank">了解更多&gt;</a>
            </p>
          </div>
        </div>
        ...
        <div class="pro-list-section" id="qqjx">
          ...
          <div class="pro-desc">
            ...
            <p>适读年龄：2-6岁<br>
              ...
              在孩子的眼里，影子是什么样子呢？有时候影子是一个吓得猫咪跳起的大怪物：有时候，影子像一个迅速蹿高的大皮球：有时候影子是一个怕黑的胆小鬼：有时候，影子像一个淘气的大懒虫…… 清新温暖的复古画风，带着律动的诗话语言，天马行空的想象力……<br>
              本书可以引导孩子用探求的眼光发现影子的千变万化，发现生活中的细节，训练孩子的观察能力。<br>
              书中关于光影变化的知识，有助于孩子科学素养的启蒙。
              <br><a href="http://children.tesoon.com/" class="text-primary" target="_blank">了解更多&gt;</a></p>
          </div>
        </div>
